...
class FollowingState {
  List<Itinerary> followingFriendsItineraries;
  List<Itinerary> followingItineraries;

  FollowingState({ required this.followingFriendsItineraries,required this.followingItineraries});
}
